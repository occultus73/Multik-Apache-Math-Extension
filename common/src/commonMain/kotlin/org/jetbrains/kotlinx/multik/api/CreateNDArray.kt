 ...
 */
inline fun <reified T : Number, reified D : Dimension> Multik.empty(vararg dims: Int): NDArray<T, D> {
 ...
 */
fun <T : Number, D : Dimension> Multik.empty(dims: IntArray, dtype: DataType): NDArray<T, D> {
    // TODO check data type
    val dim = dimensionOf<D>(dims.size)
    requireDimension(
        dim,
        dims.size
    ) // TODO (mk.empty<Float, D2>(intArrayOf(3), DataType.FloatDataType))
 ...
 */
inline fun <reified T : Number> Multik.identity(n: Int): D2Array<T> {
    val dtype = DataType.of(T::class)
 ...
 */
fun <T : Number> Multik.identity(n: Int, dtype: DataType): D2Array<T> {
 ...
 */
@JvmName("ndarray1D")
inline fun <reified T : Number> Multik.ndarray(arg: List<T>): D1Array<T> {
    val dtype = DataType.of(T::class)
    listOf(1, 2)
 ...
 */
@JvmName("ndarray2D")
inline fun <reified T : Number> Multik.ndarray(arg: List<List<T>>): D2Array<T> {
    val dtype = DataType.of(T::class)
    val size = IntArray(2)
    size[0] = arg.size
 ...
 */
@JvmName("ndarray3D")
inline fun <reified T : Number> Multik.ndarray(arg: List<List<List<T>>>): D3Array<T> {
    val dtype = DataType.of(T::class)
    val size = IntArray(3)
    size[0] = arg.size
    size[1] = arg.first().size
 ...
 */
@JvmName("ndarray4D")
inline fun <reified T : Number> Multik.ndarray(arg: List<List<List<List<T>>>>): D4Array<T> {
    val dtype = DataType.of(T::class)
    val size = IntArray(4)
    size[0] = arg.size
    size[1] = arg.first().size
 ...
 */
inline fun <T : Number, reified D : Dimension> Multik.ndarray(
 ...
 */
fun <T : Number, D : Dimension> Multik.ndarray(
...
fun Multik.ndarray(args: ByteArray, dim1: Int, dim2: Int, dim3: Int): D3Array<Byte> {
    ...
    return D3Array<Byte>(
        data,
        shape = intArrayOf(dim1, dim2, dim3),
        dtype = DataType.ByteDataType,
        dim = D3
    )
}
...
fun Multik.ndarray(args: ByteArray, dim1: Int, dim2: Int, dim3: Int, dim4: Int): D4Array<Byte> {
    ...
    return D4Array<Byte>(
        data,
        shape = intArrayOf(dim1, dim2, dim3, dim4),
        dtype = DataType.ByteDataType,
        dim = D4
    )
}
...
fun Multik.ndarray(
    ...
    val data = MemoryViewByteArray(args)
    return NDArray<Byte, DN>(
        data,
        shape = shape,
        dtype = DataType.ByteDataType,
        dim = dimensionOf(shape.size)
    )
}
 ...
 */
inline fun <reified T : Number> Multik.d1array(sizeD1: Int, noinline init: (Int) -> T): D1Array<T> {
 ...
 */
inline fun <reified T : Number> Multik.d2array(
    sizeD1: Int,
    sizeD2: Int,
    noinline init: (Int) -> T
): D2Array<T> {
 ...
 */
inline fun <reified T : Number> Multik.d4array(
 ...
 */
inline fun <reified T : Number> Multik.dnarray(
 ...
 */
inline fun <reified T : Number, reified D : Dimension> Multik.dnarray(
    dims: IntArray,
    noinline init: (Int) -> T
): NDArray<T, D> {
 ...
 */
fun <T : Number> Multik.ndarrayOf(vararg items: T): D1Array<T> {
 ...
 */
inline fun <reified T : Number> Multik.arange(start: Int, stop: Int, step: Int = 1): D1Array<T> {
 ...
 */
inline fun <reified T : Number> Multik.arange(start: Int, stop: Int, step: Double): D1Array<T> {
 ...
 */
inline fun <reified T : Number> Multik.arange(stop: Int, step: Int = 1): D1Array<T> =
    arange(0, stop, step)
 ...
 */
inline fun <reified T : Number> Multik.arange(stop: Int, step: Double): D1Array<T> =
    arange(0, stop, step)
 ...
 */
inline fun <reified T : Number> Multik.linspace(start: Int, stop: Int, num: Int = 50): D1Array<T> {
 ...
 */
fun <T : Number> Iterable<T>.toNDArray(): D1Array<T> {
