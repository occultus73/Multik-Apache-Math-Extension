...
object JvmMath : Math {
    ...
    override fun <T : Number, D : Dimension, O : Dimension> argMax(
        a: MultiArray<T, D>,
        axis: Int
    ): NDArray<Int, O> {
        ...
        return NDArray<Int, O>(
            argMaxData,
            0,
            newShape,
            dtype = DataType.IntDataType,
            dim = dimensionOf(newShape.size)
        )
    }
    ...
    override fun <T : Number, D : Dimension, O : Dimension> argMin(
        a: MultiArray<T, D>,
        axis: Int
    ): NDArray<Int, O> {
    ...
    override fun <T : Number, D : Dimension, O : Dimension> max(
        a: MultiArray<T, D>,
        axis: Int
    ): NDArray<T, O> {
    ...
    override fun <T : Number, D : Dimension, O : Dimension> min(
        a: MultiArray<T, D>,
        axis: Int
    ): NDArray<T, O> {
    ...
    override fun <T : Number, D : Dimension, O : Dimension> sum(
        a: MultiArray<T, D>,
        axis: Int
    ): NDArray<T, O> {
