...
interface Math {
     ...
     */
    fun <T : Number, D : Dimension, O : Dimension> argMax(
        a: MultiArray<T, D>,
        axis: Int
    ): NDArray<Int, O>
     ...
     */
    fun <T : Number> argMaxDN(a: MultiArray<T, DN>, axis: Int): NDArray<Int, D4>
     ...
     */
    fun <T : Number, D : Dimension, O : Dimension> argMin(
        a: MultiArray<T, D>,
        axis: Int
    ): NDArray<Int, O>
     ...
     */
    fun <T : Number> argMinDN(a: MultiArray<T, DN>, axis: Int): NDArray<Int, D4>
     ...
     */
    fun <T : Number, D : Dimension, O : Dimension> max(
        a: MultiArray<T, D>,
        axis: Int
    ): NDArray<T, O>
     ...
     */
    fun <T : Number> maxDN(a: MultiArray<T, DN>, axis: Int): NDArray<T, D4>
     ...
     */
    fun <T : Number, D : Dimension, O : Dimension> min(
        a: MultiArray<T, D>,
        axis: Int
    ): NDArray<T, O>
     ...
     */
    fun <T : Number> minDN(a: MultiArray<T, DN>, axis: Int): NDArray<T, D4>
     ...
     */
    fun <T : Number, D : Dimension, O : Dimension> sum(
        a: MultiArray<T, D>,
        axis: Int
    ): NDArray<T, O>
     ...
     */
    fun <T : Number> sumDN(a: MultiArray<T, DN>, axis: Int): NDArray<T, D4>
